...
const DEFAULT_REGISTER_URL =
  'https://auth.alfares.cz/register?return_url=https%3A%2F%2Fcatalog.alfares.cz%2Fauth%2Fcallback&client_id=catalog-microservice&state=catalog-dashboard&lang=cs';
...
function buildHostedAuthUrl(): string {
  ...
  url.searchParams.set('client_id', 'catalog-microservice');
