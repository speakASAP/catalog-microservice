# Copilot Instructions — `catalog-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/catalog-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/catalog-microservice.git`, branch `main`.
