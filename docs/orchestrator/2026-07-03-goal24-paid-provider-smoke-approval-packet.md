...
- Payments success evidence: Payments `ea4fc71` records synthetic Fiobanka QR creation, owner-approved synthetic completed callback through `/webhooks/fiobanka` without manual payment-state bypass, and source-level HMAC signature hardening.
