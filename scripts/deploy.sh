#!/bin/bash
# catalog-microservice Application Deployment Script
# Usage: ./scripts/deploy.sh
#
# This script deploys the catalog-microservice application to production using the
...
echo -e "${BLUE}╔════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║     catalog-microservice Application - Production Deployment            ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
if [ $DEPLOY_EXIT_CODE -eq 0 ]; then
    ...
    echo -e "${GREEN}╚════════════════════════════════════════════════════════════╝${NC}"
    echo ""
    echo "The catalog-microservice application has been deployed using blue/green deployment."
